package com.coburn.fh.connection;
...
public class ConnectionManager {
	...
	private static final String URL = "jdbc:mysql://localhost:3306/bookmark_db";
	private static final String USERNAME = "root";
	private static final String PASSWORD = "rootroot"; // change password if needed, Mac/Linux = Root@123  |  Windows = root
